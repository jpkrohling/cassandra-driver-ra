...
public class CassandraDriverMBeanImpl implements CassandraDriverMBean
{
   ...
   /**
    * GetConnection
    * @return CassandraDriverConnection
    */
   private CassandraDriverConnection getConnection() throws Exception
   {
      InitialContext context = new InitialContext();
      CassandraDriverConnectionFactory factory = (CassandraDriverConnectionFactory)context.lookup(JNDI_NAME);
      CassandraDriverConnection conn = factory.getConnection();
      if (conn == null)
      {
